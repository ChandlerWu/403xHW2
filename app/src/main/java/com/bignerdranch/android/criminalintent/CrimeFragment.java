...
public class CrimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        mDeleteButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mCrime.setPhoto2(null);
                mCrime.setPhoto3(null);
                mCrime.setPhoto4(null);
                mCrime.resetPhotosTaken();
    ...
    private void showPhoto() {
        ...
        Photo p = mCrime.getPhoto();
        Photo p2 = mCrime.getPhoto2();
        Photo p3 = mCrime.getPhoto3();
        Photo p4 = mCrime.getPhoto4();
        ...
        if (p2 != null) {
            String path = getActivity()
                    .getFileStreamPath(p2.getFilename()).getAbsolutePath();
            b = PictureUtils.getScaledDrawable(getActivity(), path);
        }
        ...
        if (p3 != null) {
            String path = getActivity()
                    .getFileStreamPath(p3.getFilename()).getAbsolutePath();
            b = PictureUtils.getScaledDrawable(getActivity(), path);
        }
        ...
        if (p4 != null) {
            String path = getActivity()
                    .getFileStreamPath(p4.getFilename()).getAbsolutePath();
            b = PictureUtils.getScaledDrawable(getActivity(), path);
        }
        ...
        if (requestCode == REQUEST_DATE) {
            ...
            if (requestCode == REQUEST_PHOTO) {
                ...
                if (filename != null) {
                    ...
                    switch (mCrime.getPhotosTaken() % 4) {
                        case 0: mCrime.setPhoto(p);
                            break;
                        case 1: mCrime.setPhoto2(p);
                            break;
                        case 2: mCrime.setPhoto3(p);
                            break;
                        case 3: mCrime.setPhoto4(p);
                            break;
                    }
                    mCrime.onePhotosTaken();
                    showPhoto();
                }
            }
        }
